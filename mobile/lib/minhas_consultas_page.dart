                  ...
                  Row(
                    children: [
                      Container(
                        width: 36,
                        height: 36,
                        decoration: BoxDecoration(color: const Color(0xFFE6E1D9), borderRadius: BorderRadius.circular(10)),
                        child: const Icon(Icons.calendar_month, color: Color(0xFFA87B05)),
                      ),
                      const SizedBox(width: 12),
                ...
                child: TabBarView(
                  ...
                  children: [
                    ...
                    ListView(
                      ...
                      children: [
                        _buildCard(day: '14', month: 'NOV', name: 'Dra. Sofia Lima', specialty: 'Higiene Oral', time: '10:30', weekday: 'Qui, 14 Nov', status: 'Confirmado', statusColor: Colors.green.shade100),
                        ...
                        _buildCard(day: '02', month: 'DEZ', name: 'Dra. Inês Carvalho', specialty: 'Implantologia', time: '15:00', weekday: 'Seg, 02 Dez', status: 'Confirmado', statusColor: Colors.green.shade100),
                        const SizedBox(height: 12),
                        const Text('Histórico', style: TextStyle(fontWeight: FontWeight.w600)),
                        const SizedBox(height: 8),
                        _buildCard(day: '28', month: 'OUT', name: 'Dra. Sofia Lima', specialty: 'Higiene Oral', time: '11:30', weekday: 'Seg, 28 Out', status: 'Confirmado', statusColor: Colors.green.shade100),
                        _buildCard(day: '12', month: 'OUT', name: 'Dr. Ricardo Nunes', specialty: 'Cirurgia Oral', time: '14:00', weekday: 'Sáb, 12 Out', status: 'Pendente', statusColor: Colors.amber.shade100),
                      ],
                    ),
