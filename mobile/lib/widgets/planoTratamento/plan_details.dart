...
class PlanDetails extends StatelessWidget {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(color: const Color(0xFFF7F4F2), borderRadius: BorderRadius.circular(8)),
            child: const Text('Corrigir apinhamento e melhorar oclusão\nClasse I'),
          ),
          ...
          Container(
            padding: const EdgeInsets.all(12),
            decoration: BoxDecoration(color: const Color(0xFFF7F4F2), borderRadius: BorderRadius.circular(8)),
            child: const Text('Alinhadores sequenciais, ajustes oclusais, contenções.'),
          ),
          const SizedBox(height: 10),
          ...
          Container(
            padding: const EdgeInsets.all(12),
            decoration: BoxDecoration(color: const Color(0xFFF7F4F2), borderRadius: BorderRadius.circular(8)),
            child: const Text('Alinhadores termoplásticos, attachments, elásticos intermaxilares.'),
          ),
          const SizedBox(height: 10),
          ...
          Container(
            padding: const EdgeInsets.all(12),
            decoration: BoxDecoration(color: const Color(0xFFF7F4F2), borderRadius: BorderRadius.circular(8)),
            child: const Text('Uso 22h/dia, higiene oral rigorosa, check-ups quinzenais.'),
          ),
          const SizedBox(height: 12),
          SizedBox(
            height: 44,
            child: ElevatedButton(
              style: ElevatedButton.styleFrom(
                backgroundColor: const Color(0xFF2F9C50),
  ...
  Widget _sectionTitle(String text) => Text(text, style: const TextStyle(fontWeight: FontWeight.w600));
}
